...
public class SwerveDrive extends SubsystemBase {
  ...
  public SwerveDrive(ShooterLimelight limelightShooter) {
    ...
    poseEstimator.addVisionMeasurement(limelightShooter.getBotPoseBlue().toPose2d(), Timer.getFPGATimestamp() - difference);
  ...
  public Command turnTo(Rotation2d heading) { 
    return new MotionProfiling(this, () -> swerveDriveOdometry.getPoseMeters().getX(), () -> swerveDriveOdometry.getPoseMeters().getY(), () -> heading);
  }
  ...
  public Command moveTo(double x, double y) { 
    return new MotionProfiling(this, () -> x, () -> y, () -> swerveDriveOdometry.getPoseMeters().getRotation());
  }
  ...
  public void updateOdometryLimelight(){
  ...
  public Pose2d getPose2d(){
    return new Pose2d(
      swerveDriveOdometry.getPoseMeters().getX(), 
      swerveDriveOdometry.getPoseMeters().getY(), 
  ...
  public void periodic() {
    ...
    updateOdometryLimelight();

    modulesPeriodic();
    Pose3d botPosition = limelightShooter.getBotPoseBlue(); 
    SmartDashboard.putNumber("x", botPosition.getX());
    SmartDashboard.putNumber("y", botPosition.getY());
    SmartDashboard.putNumber("z", botPosition.getZ());
    SmartDashboard.putNumber("Bot Pose Angle", botPosition.getRotation().getAngle());
    ...
    SmartDashboard.putNumber("estimated yaw (rotation)",poseEstimator.getEstimatedPosition().getRotation().getDegrees());
