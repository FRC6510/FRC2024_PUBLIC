...
public class SwerveDrive extends SubsystemBase {
  ...
  public double setpoint;
    ...
    // Locations for the swerve drive modules relative to the robot centre. 
    private final Translation2d
    frontLeftLocation = new Translation2d(0.315, 0.315),
    frontRightLocation = new Translation2d(0.315, -0.315),
    backLeftLocation = new Translation2d(-0.315, 0.315),
    backRightLocation = new Translation2d(-0.315, -0.315);

    Translation2d[] modulePositions = {frontRightLocation, frontLeftLocation, backLeftLocation, backRightLocation}; // Unit circle declaration 
  ...
  public SwerveDrive() {
    ...
    swerveDriveKinematics = new SwerveDriveKinematics(modulePositions);
    ...
    swerveDriveOdometry = new SwerveDriveOdometry(
      ...
      }, new Pose2d(0, 0, new Rotation2d()));//TODO check with Ben if x and y values should be set to 0
