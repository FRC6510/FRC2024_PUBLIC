...
public class SwerveModule {
  ...
  SlewRateLimiter filter = new SlewRateLimiter(0.5);//TODO do acceleration limiting for the swerve module 
  ...
  public SwerveModule (int driveMotorId, int steerMotorId, int absoluteEncoderId, boolean driveMotorReversed, boolean steerMotorReversed, double absoluteEncoderOffset, boolean absoluteEncoderReversed){
    ...
    currentlimits.StatorCurrentLimit = 75;//TODO test for value 
    ...
    driveMotor.getConfigurator().apply(currentlimits, 0.50);
  }
