...
public class SwerveModule {
  ...
  */
  public SwerveModuleState getState() {
    ...
    driveMotor.getVelocity().getValueAsDouble() * SwerveConstants.moduleConstants.DISTANCE_PER_WHEEL_REV, 
    Rotation2d.fromDegrees(absoluteEncoder.getAbsolutePosition().getValueAsDouble()));
  }

  public SwerveModulePosition getPosition(){
    return new SwerveModulePosition(
      driveMotor.getPosition().getValueAsDouble() * SwerveConstants.moduleConstants.DISTANCE_PER_WHEEL_REV, 
  ...
  public void setDesiredState(SwerveModuleState desiredState){
    ...
    setModuleVelocity(toRPS(desiredState.speedMetersPerSecond));// check this constant (3.5)
  }
  ...
  public static double toRPS(double tangentialVelocity){
    return tangentialVelocity / SwerveConstants.moduleConstants.DISTANCE_PER_WHEEL_REV;
  }
  ...
  public static double toTangentialVelocity(double rps){
    return rps * SwerveConstants.moduleConstants.DISTANCE_PER_WHEEL_REV;
  }
