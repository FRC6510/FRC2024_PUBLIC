...
// import frc.robot.subsystems.limelight.SwitchPipeline.PipelineID;
...
//     // NetworkTableInstance.getDefault().getTable("limelight-shooter").getEntry("limelight-shooter").getDoubleArray(new double[6]);
