...
public class Lift extends SubsystemBase {
  ...
  public static void setLiftPosition(double rotations){
    final MotionMagicVoltage setLiftPosition = new MotionMagicVoltage(0);
    INSTANCE.liftMotor.setControl(setLiftPosition.withPosition(rotations));
  }

  public static Command moveLift(double rotations){
    return new MoveLift(rotations);
  }
