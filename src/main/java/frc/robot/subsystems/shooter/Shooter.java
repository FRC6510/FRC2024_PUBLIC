...
public class Shooter extends SubsystemBase {
  ...
  public void periodic() {
    ...
    SmartDashboard.putNumber("Shootor Bottom Velocity", bottom.getEncoder().getVelocity());
    // This method will be called once per scheduler run
  }

  public static Command spinShooter(DoubleSupplier powerSupplier){
    return new SpinShooter(powerSupplier);
  }

  public static Command spinShooterSimple(double power){
    return new SpinShooterSimple(power);
  }
}