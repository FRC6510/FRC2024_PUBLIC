...
public class SpinIntakeVariablePower extends Command {
  ...
  public SpinIntakeVariablePower(Intake intake, Feeder feeder, Lift lift, DoubleSupplier rps) {
    this.intake = intake;
    this.feeder = feeder;
    this.lift = lift;
    this.rps = rps;
  ...
  public void execute() {
    ...
    intake.setIntakeVelocity(() -> rps.getAsDouble());
