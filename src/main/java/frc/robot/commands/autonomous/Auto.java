...
import frc.robot.subsystems.shooterfeeder.SpinShooterFeeder;
    ...
    public Command getAuto(AutoList auto){
        ...
        switch(auto) {
            ...
            return Commands.sequence(
                ...
                new PrintCommand("DDU Blue Auto"), 

                //prepares shooter 
                new ShooterPID(robotContainer.shooter,()->1.0).withTimeout(2),

                //shoot preload
                new ParallelCommandGroup(
                    new ShooterPID(robotContainer.shooter,()->1.0),
                    robotContainer.shooterFeeder.spinShooterFeeder(0.5),
                    robotContainer.feeder.simpleSpinFeeder(-0.5)
                ).withTimeout(2),

                //go to centre red note and intake
                new ParallelCommandGroup(
                    robotContainer.swerveDrive.moveAndTurn(BLUE_NOTE_CENTRE_X, BLUE_NOTE_CENTRE_Y, Rotation2d.fromDegrees(0)),
                    robotContainer.intake.spinThrice(20),
                    robotContainer.feeder.spinFeeder(-20)
                ).withTimeout(2),

                //prepare shooter and move to shooting position
                new ParallelCommandGroup(
                    robotContainer.swerveDrive.moveAndTurn(-7.1, 1.5, new Rotation2d(0)),
                    new ShooterPID(robotContainer.shooter, ()->1.0)
                ).withTimeout(2),
                ...
                //go to note on the right and intake
                new ParallelCommandGroup(
                    robotContainer.swerveDrive.moveAndTurn(BLUE_NOTE_RIGHT_X, BLUE_NOTE_RIGHT_Y, Rotation2d.fromDegrees(0)),
                    robotContainer.intake.spinThrice(20),
                    robotContainer.feeder.spinFeeder(-20)
                ).withTimeout(2),

                //prepare shooter and go to position to shoot
                new ParallelCommandGroup(
                    robotContainer.swerveDrive.moveAndTurn(-7.1, 1.5, Rotation2d.fromDegrees(0)),
                    new ShooterPID(robotContainer.shooter,()->1.0)
                ).withTimeout(2),
            ...
            return Commands.sequence(
                ...
                //go to centre red note and intake
                new ParallelCommandGroup(
                    robotContainer.swerveDrive.moveAndTurn(RED_NOTE_CENTRE_X, RED_NOTE_CENTRE_Y, Rotation2d.fromDegrees(0)),
                    robotContainer.intake.spinThrice(20),
                    robotContainer.feeder.spinFeeder(-20)
                ).withTimeout(2),
                ...
                //go to note on the right and intake
                new ParallelCommandGroup(
                    robotContainer.swerveDrive.moveAndTurn(RED_NOTE_RIGHT_X, RED_NOTE_RIGHT_Y, Rotation2d.fromDegrees(0)),
                    robotContainer.intake.spinThrice(20),
                    robotContainer.feeder.spinFeeder(-20)
                ).withTimeout(2),
        ...
        //A Short Collection of "Code" 

            //Slow Crafting by 6510 Coders (The OJs) - Haiku
              //for ourselves because we are amazing
                //slow mechanical
            ...
            //Deforestation is Devastation by 6510 Coders (The OJs) - Couplets
              //for anna the orangutans #protect #save anna's cousins
                //pools are cool
                //school is drool
                ...
                //deforestation is devastation.

            //Coral Bleaching is Breaching by 6510 Coders (The OJs) - Freeverse
              //for liuyi for giving your life to a good cause
                //water is cool
                //ocean is motion
            ...
            //Gender Pay Gap by 6510 Coders (The OJs) - Acrostic
              //for jahle your social rights slayer
                //justice
                //equality
                //no
                //deficit
            ...
            //Ultimate Frisbee by 6510 Coders (The OJs) - Diamond 
              //for jackie our frisbee
                //spin
                //rotation 2d
                //drivetrain move to
                //spin, score
            ...
            //Let It Go by 6510 Coders (The OJs) - Limerick
              //for elysia and embracing mistakes
                //eating dried mango
                //throwing a fried flamingo
                //fall on your back
                //have a heart attack
                //but let it all go...

            //by 6510 Coders (The OJs) ft. Jackie - Sonnet
              //for mr becker, and Thina our favourite mentor
                //the sunset shimmers over the toyota dealership
                //feeling uninspired until a motivation strike
                //adoration in computer chip
                //in robotics we like

                //through laughter heard loud and clear
                //we bond, our hearts growing full
                //as we share a loctite, robotic's beer
                //we stare at the robot, damn its beautiful

                //the robot, humming in the light of the dusk
                //meets our piercing stare
                //as it glances back at us
                //"oh how do you fare"

                //our eyes widen, what did we just see
                //a halocination, from our delirium, oh golly jee.  
            
            //THE INVASION OF BARKER (PYMBLE STRIKES BACK)
                //in the harsh light of the robotics room
                //in the deafening silence of this jail
                //welcome barker, to your doom
                //for this is pymble, in which you pale

                //pymble pride takes over the world
                //would be whispered in the barker halls
                //as your dictator, in which we hurled
                //"oh no, don't take us now" barker would cry as they ball

                //a devilish smile would spread over our lips
                //with the hammer in our hands, we would cry 
                //this is pymble pride, you will not resist
                //this is your time to say goodbye

                //and in that, we would end with barker down low
                //voce fedorento, por que, voce pay do. 
        ...
        // lucy, lisa, thina, mr becker, oscar

            //8 for hard by 6510 Coders (The OJs) - Rhetorical
              //for ben ten
                //on a scale of 1 to 5 how would you rate my bee hive?
                //on a scale of 1 to 10 how would my ben ten pen?
