        ...
        switch(auto) {
            ...
            return Commands.sequence(
                ...
                new ParallelCommandGroup(
                    ...
                    robotContainer.shooterPivot.shooterPivotPID(robotContainer.shooterPivot, () -> 15.5),
                    SpinFeedShooter.autoSpinFeedShoot(robotContainer.shooter, robotContainer.shooterFeeder, robotContainer.feeder, () -> 0.7, () -> 0.4, () -> -40)),                
                
                //go to 1st note, intake 1st note, shoot 1st note
                new ParallelCommandGroup(
                    robotContainer.intake.spinIntake(() -> 40), 
                ...
                robotContainer.swerveDrive.moveAndTurn(-5.9, 1.69, Rotation2d.fromDegrees(0)),
                new ParallelCommandGroup(
                    robotContainer.swerveDrive.moveAndTurn(-5.6, 1.69, Rotation2d.fromDegrees(0)),
                    robotContainer.intake.spinIntake(() -> 40), 
                    robotContainer.feeder.spinFeeder(() -> -40),
                ...
                robotContainer.swerveDrive.moveAndTurn(-5.85, 2.9, Rotation2d.fromDegrees(25)),
                new ParallelCommandGroup(
                    robotContainer.swerveDrive.moveAndTurn(-5.45, 2.9, Rotation2d.fromDegrees(25)),
                    robotContainer.intake.spinIntake(() -> 40), 
                    robotContainer.feeder.spinFeeder(() -> -40),
                    robotContainer.shooterPivot.shooterPivotPID(robotContainer.shooterPivot, () -> 15),
                    SpinFeedShooter.autoSpinFeedShoot(robotContainer.shooter, robotContainer.shooterFeeder, robotContainer.feeder, () -> 0.7, () -> 0.4, () -> -40)),
                ...
                new ParallelCommandGroup(
                    robotContainer.swerveDrive.moveAndTurn(0.3, 3.5, Rotation2d.fromDegrees(0)),
                    robotContainer.intake.spinIntake(() -> 40), 
                    robotContainer.feeder.spinFeeder(() -> -40)),
                new ParallelCommandGroup(
                    robotContainer.swerveDrive.moveAndTurn(-4, 2.5, Rotation2d.fromDegrees(15)),
