        ...
        switch(auto) {
            ...
            return Commands.sequence(
                ...
                new ParallelCommandGroup(
                    ...
                    robotContainer.intake.spinIntake(() -> 50, robotContainer.lift), 
                    robotContainer.feeder.spinFeeder(() -> -50),
                    SpinFeedShooter.autoSpinFeedShoot(robotContainer.shooter, robotContainer.shooterFeeder, robotContainer.feeder, () -> 0.9, () -> 0.4, () -> -40),
                ...
                new ParallelCommandGroup(
                    ...
                    SpinFeedShooter.autoSpinFeedShoot(robotContainer.shooter, robotContainer.shooterFeeder, robotContainer.feeder, () -> 0.9, () -> 0.4, () -> -40)).withTimeout(2),

                //shoot 3rd note, go to 4th note 
                new ParallelCommandGroup(
                    robotContainer.swerveDrive.moveAndTurn(0, 3.35, Rotation2d.fromDegrees(0)),
                    robotContainer.intake.spinIntake(() -> 50, robotContainer.lift), 
                    robotContainer.feeder.spinFeeder(() -> -50)).withTimeout(2),
                
                new ParallelCommandGroup(
                    robotContainer.intake.spinIntake(() -> 30, robotContainer.lift), 
                    robotContainer.feeder.spinFeeder(() -> -30),
                    robotContainer.swerveDrive.moveAndTurn(-3.7, 2.5, Rotation2d.fromDegrees(17)),
                    robotContainer.shooterPivot.shooterPivotPID(robotContainer.shooterPivot, () -> 19),
                    SpinFeedShooter.autoSpinFeedShoot(robotContainer.shooter, robotContainer.shooterFeeder, robotContainer.feeder, () -> 1, () -> 0.5, () -> -50)).withTimeout(2.5),
            ...
            return Commands.sequence(
                ...
                new ParallelCommandGroup(
                    ...
                    new SequentialCommandGroup(
                        new WaitCommand(0.2),
                        SpinFeedShooter.autoSpinFeedShoot(robotContainer.shooter, robotContainer.shooterFeeder, robotContainer.feeder, () -> 0.9, () -> 0.4, () -> -40))).withTimeout(2.5),
                ...
                new ParallelCommandGroup(
                    ...
                    SpinFeedShooter.autoSpinFeedShoot(robotContainer.shooter, robotContainer.shooterFeeder, robotContainer.feeder, () -> 0.8, () -> 0.4, () -> -40)).withTimeout(2),
            ...
            return Commands.sequence(
                ...
                //shoot preload
                new ParallelCommandGroup(
                    SpinFeedShooter.autoSpinFeedShootWithCoords(robotContainer.shooter, robotContainer.shooterFeeder, robotContainer.feeder, () -> 0.8, () -> 0.4, () -> -40, -6.3, 0.2),             
                    robotContainer.swerveDrive.moveAndTurn(-6.3, 0.2, Rotation2d.fromDegrees(-35)),
                    robotContainer.shooterPivot.shooterPivotPID(robotContainer.shooterPivot, () -> 12)).withTimeout(2),
                
                //go to 1st note, intake 1st note, shoot 1st note
                new ParallelCommandGroup(
                    SpinFeedShooter.autoSpinFeedShoot(robotContainer.shooter, robotContainer.shooterFeeder, robotContainer.feeder, () -> 0.8, () -> 0.4, () -> -40),
                ...
                new ParallelCommandGroup(
                    ...
                    robotContainer.intake.spinIntake(() -> 50, robotContainer.lift), 
                    robotContainer.feeder.spinFeeder(() -> -50)).withTimeout(2.5),
            ...
            return Commands.sequence(
                ...
                // case BLUE_TEST_CURVING:
                // return Commands.sequence(
                //     robotContainer.shooterPivot.shooterPivotPID(robotContainer.shooterPivot, () -> 0),
                //     new PrintCommand("Blue test"),
                //     new InstantCommand(() -> robotContainer.swerveDrive.setRobotPosition(
                //         new Pose2d(-7.5, 0.1, Rotation2d.fromDegrees(-61.2))), 
                //         robotContainer.swerveDrive),
                //     // front 3  
                //     new InstantCommand(() -> robotContainer.shooterPivot.setIdle(NeutralModeValue.Brake), robotContainer.shooterPivot),

                //     robotContainer.swerveDrive.moveAndTurnCurve(-7.5, -1.5, 0.5,  Rotation2d.fromDegrees(-61.2)),

                //     robotContainer.swerveDrive.moveAndTurn(-5, -1.5, Rotation2d.fromDegrees(-61.2)));

                //     // robotContainer.swerveDrive.moveAndTurn(-2, -1.5, Rotation2d.fromDegrees(-61.2)));           
