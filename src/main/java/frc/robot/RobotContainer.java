...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    chooser.addOption("Blue just move", auto.getAuto(AutoList.BLUE_JUST_MOVE));// Max 32 points
    chooser.addOption("3 cycles test", auto.getAuto(AutoList.BLUE_WITH_CYCLES));// Max 32 points
    chooser.addOption("Cycles test", auto.getAuto(AutoList.TEST_INTAKING));// Max 32 points
    ...
    .onFalse(
     ...
     operatorController.leftBumper().onTrue(
      new ParallelCommandGroup(
        intake.spinIntake(() -> -15), 
        feeder.spinFeeder(() -> 15)))
    .onFalse(
      new ParallelCommandGroup(
        intake.spinIntake(() -> 0), 
        feeder.spinFeeder(() -> 0)));
  ...
  operatorController.leftTrigger(0.1)
    ...
    .whileTrue(shooterPivot.shooterPivotPID(shooterPivot, () -> 4))
    .whileFalse(shooterPivot.shooterPivotPID(shooterPivot, () -> 0));

    operatorController.b()
    .whileTrue(shooterPivot.shooterPivotPID(shooterPivot, () -> 15))//16
    .whileFalse(shooterPivot.shooterPivotPID(shooterPivot, () -> 0));
    ...
    .whileTrue(shooterPivot.shooterPivotPID(shooterPivot, () -> 23))
    .whileFalse(shooterPivot.shooterPivotPID(shooterPivot, () -> 0));
